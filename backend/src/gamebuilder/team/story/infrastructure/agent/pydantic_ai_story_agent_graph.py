...
from gamebuilder.team.story.application.story_contracts import (
...
class PydanticAIStoryAgentGraph:
    """StoryAgentGraph backed by PydanticAI agents with structured outputs."""
    ...
    def __init__(
        ...
        *,
        ...
        self._draft_agent: Agent[None, StoryArtifactBundle] = Agent(
            model,
            output_type=StoryArtifactBundle,
        ...
        self._revise_agent: Agent[None, StoryArtifactBundle] = Agent(
